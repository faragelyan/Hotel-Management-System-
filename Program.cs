...
public class Program
{
    static void Main(string[] args)
    {
        ...
        while (continueLoop) // Keep the system running until the user chooses to exit
        {
            ...
            else if (choice == 2)
            {
                ...
                Console.WriteLine("Enter role (Manager/Receptionist):");
        ...
        // Exit message when the user decides not to log in again
    ...
    {
        // Validate that the role is either Manager or Receptionist
        if (role != "Manager" && role != "Receptionist")
        {
            Console.WriteLine("Invalid role. Only 'Manager' or 'Receptionist' are allowed.");
            return;
        }

        // Check if the username already exists
        string[] lines = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\users.txt");
        ...
        File.AppendAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\users.txt", new[] { newUser });
...
public class InitialDataSetup
{
    public static void WriteInitialData()
    {
        ...
        File.WriteAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\users.txt", users);

        // Write initial data for workers.txt
        string[] workers = {
            "John Doe,Manager,1000,50000",
            "Jane Smith,Receptionist,500,60000",
            "Jack Black,Housekeeper,400,75000"
            // Add more workers as needed
        };
        File.WriteAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\workers.txt", workers);
        ...
        File.WriteAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\rooms.txt", rooms);
        ...
        File.WriteAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\residents.txt", residents);
        ...
        File.WriteAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\income.txt", income);
...
public class Manager
{
    ...
    private void AddWorker()
    {
        ...
        var workers = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\workers.txt").ToList();
    ...
    {
        var workers = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\workers.txt");
    ...
    {
        var residents = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\residents.txt");
    ...
    {
        var rooms = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\rooms.txt");
    ...
    {
        var income = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\income.txt");
...
public class Receptionist
{
    ...
    private void AddResident()
    {
        ...
        var residents = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\residents.txt").ToList();
    ...
    private void AssignRoom()
    {
        ...
        var rooms = File.ReadAllLines(@"C:\Users\MOHAMED\Desktop\DP_FILES\rooms.txt").ToList();
